...
- **target** *numeric [0.0, 1.0)*, required, budget target for given objective
  of the SLO. A `target: 0.9995` is equivalent to `targetPercent: 99.95`.

- **targetPercent**: *numeric [0.0, 100)*, required, budget target for given
  objective of the SLO. A `targetPercent: 99.95` is equivalent to `target: 0.9995`.
